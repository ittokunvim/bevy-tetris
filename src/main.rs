...
const PATH_IMAGE_ANGLE_DOWN: &str = "images/angle-down.png";
const PATH_IMAGE_ANGLE_LEFT: &str = "images/angle-left.png";
const PATH_IMAGE_ANGLE_RIGHT: &str = "images/angle-right.png";
const PATH_IMAGE_ANGLE_UP: &str = "images/angle-up.png";
const PATH_IMAGE_HOLD: &str = "images/hand-holding-medical.png";
const PATH_IMAGE_FALL: &str = "images/person-falling.png";
